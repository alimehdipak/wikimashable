...
PushlySDK.watch('ready', () => {
    const qs = [...document.querySelectorAll('meta[property="og:article:tag"]')];
    if (qs.length) {
        PushlySDK.push(['page_tag_visit', qs.flatMap(n => n.content.trim().toLowerCase())]);
    }
});
